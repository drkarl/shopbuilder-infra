...
variable "primary_region" {
  ...
  validation {
    ...
    error_message = "Primary region must be one of: us-east-1, us-west-1, us-west-2, eu-central-1, eu-west-1, sa-east-1, ap-northeast-1, ap-southeast-1, ap-southeast-2."
  }
}
