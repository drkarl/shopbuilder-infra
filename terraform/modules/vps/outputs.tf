...
output "public_ip" {
  ...
  value = var.provider_type == "scaleway" ? (
    ...
    length(ovh_cloud_project_instance.this) > 0 ? ovh_cloud_project_instance.this[0].addresses[0].ip : null
  )
}
...
output "ssh_connection_string" {
  ...
  value = var.provider_type == "scaleway" ? (
    ...
    length(ovh_cloud_project_instance.this) > 0 ? "ssh ${var.ssh_user}@${ovh_cloud_project_instance.this[0].addresses[0].ip}" : null
  )
}
